...
@section('content')
        ...
        <div class="me-auto">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('series.show', $series->id) }}">{{ $series->title }}</a>
                    </li>
    ...
    <div class="card">
        <div class="card-body ">
            <form action="{{ route('series.episodes.update', $episode->id) }}" class="w-50" method="POST">
                @csrf
                @method('PUT')
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-9">
                        <input type="text" class="mb-3 form-control @error('watch_link') is-invalid @enderror" name="watch_link"
                            placeholder="https://www.test.com/link/of/watch/url" value="{{ $episode->watch_link }}">
                        @error('watch_link')
                            <p class="invalid-feedback">{{ $message }}</p>
                        @enderror
                    </div>
